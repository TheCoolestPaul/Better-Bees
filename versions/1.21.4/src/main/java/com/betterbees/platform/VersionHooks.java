...
public final class VersionHooks {
    ...
    public static CompoundTag saveHive(BeehiveBlockEntity hive, HolderLookup.Provider registries) { return hive.saveWithoutMetadata(registries); }
    public static void loadHive(BeehiveBlockEntity hive, CompoundTag tag, HolderLookup.Provider registries) { hive.loadWithComponents(tag, registries); }
    public static CompoundTag saveBee(Bee bee) { CompoundTag tag = new CompoundTag(); bee.saveWithoutId(tag); return tag; }
